...
=== List all persons in sorted alphabetical order: `sort`

Similar to list but in a sorted list.
...
Edits person with given index
Format: `edit <NEWNAME> /p<PHONE> /e<EMAIL> /i<INDEX>`
...
* `list` + 
`edit John Doe p/98765432 e/johnd@gmail.com /i1` +
Edits the 1st person details according to user input 
